...
- GraphTransformerEncoder:
    ...
    graph_embeddings as input, which are typically generated by the GraphEmbedding class in state_graph_embedding.py.
- GraphPolicyNetwork:
...
- TopologyPolicyAgent:
    An agent class that integrates the topology, embedding, and policy network. It retrieves the full state 
    embedding from the embedding (using node_embeddings and graph_embeddings from state_graph_embedding.py), 
...
- PyTorch
- state_graph_embedding.py (for GraphEmbedding, which provides node_embeddings and graph_embeddings)
- topology.py, substrate.py (for environment setup)
Highlights:
-----------
- The GraphTransformerEncoder relies on node_embeddings and graph_embeddings from state_graph_embedding.py to provide 

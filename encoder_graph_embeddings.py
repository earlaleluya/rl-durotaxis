...
- GraphTransformerEncoder:
    ...
    graph_embeddings as input, which are typically generated by the GraphEmbedding class in embedding_dgl.py.
- GraphPolicyNetwork:
...
- TopologyPolicyAgent:
    ...
    embedding from the embedding (using node_embeddings and graph_embeddings from embedding_dgl.py), 
...
- PyTorch
- embedding_dgl.py (for GraphEmbedding, which provides node_embeddings and graph_embeddings)
- topology.py, substrate.py (for environment setup)
Highlights:
-----------
- The GraphTransformerEncoder relies on node_embeddings and graph_embeddings from embedding_dgl.py to provide 
